...
<head>
  <title>Lesson Search - Innovakids</title>
...
?>                             </span>
                        ...
                        <a href="account-classconcepts.php" class="list-group-item">

                            <i class="fa fa-cog text-primary"></i> &nbsp;&nbsp;Class Concepts
                        ...
                        <a href="account-classassignments.php" class="list-group-item">
