...
<head>
  <title>Concepts Search - Innovakids</title>
...
name=keywords>
  ...
  <!-- App CSS -->
  <link rel="stylesheet" href="./css/mvpready-admin-royal.css">
    ...
    function Loading()
          {
               ...
               document.getElementById('class-codetitle').innerHTML = getCookie('class-codetitle');
              ...
              <div class="portlet-body">                
                    ...
                    <div class="list-group">  
                        ...
                        <a href="account-classenrollment.php" class="list-group-item">
                            ...
                            <i class="fa fa-cog text-primary"></i> &nbsp;&nbsp;Class Enrollment
...
$tsql = "Select count(*) As ClassCount from StudClas where ClassNo = '".$_COOKIE['classno']."'";     
...
?>                             </span>
                            ...
                            <i class="fa fa-cog text-primary"></i> &nbsp;&nbsp;Class Lessons
                            <i class="fa fa-chevron-right list-group-chevron"></i>

                        </a> 
                        <a href="account-classes.php" class="list-group-item">

                            <i class="fa fa-cog text-primary"></i> &nbsp;&nbsp;Concept Analysis
                            <i class="fa fa-chevron-right list-group-chevron"></i>

                        </a> 

                        <a href="account-standards.php" class="list-group-item">

                            <i class="fa fa-cog text-primary"></i> &nbsp;&nbsp;Standards
                            <i class="fa fa-chevron-right list-group-chevron"></i>

                        </a> 

                        <a href="account-questions.php" class="list-group-item">

                            <i class="fa fa-cog text-primary"></i> &nbsp;&nbsp;Questions
                            <i class="fa fa-chevron-right list-group-chevron"></i>
                        ...
                        <a href="account-classtests.php" class="list-group-item">
                            ...
                            <i class="fa fa-cog text-primary"></i> &nbsp;&nbsp;Tests
                            <i class="fa fa-chevron-right list-group-chevron"></i>
          ...
          <div class="col-md-9 col-sm-9">
            ...
            <div class="portlet">
                ...
                <h3 class="portlet-title">
                    <u>Concept List</u>
                    <a href="account-lessonview.php" class="btn btn-secondary"><< Back</a>&nbsp;&nbsp;
                    <a href="mainmenu.php" class="btn btn-secondary">Home</a>&nbsp;&nbsp;
                    <a href="account-classadd.php" class="btn btn-secondary">Add New Concept</a>&nbsp;&nbsp;
                ...
                <br>
                 <label for="class-lessontitle"  id="class-codetitle" style="font-size:18px"></label>
...
<div id="imgbox"></div>
                ...
                <div class="portlet-body">
                   <div class="table-responsive">
                    <table class="table table-striped table-bordered thumbnail-table" id="table-1">
...
<!-- Plugin JS -->
<script src="./js/lessons/table_concepts.js"></script>
