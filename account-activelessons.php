...
<head>
  <title>Active Lesson - Innovakids</title>
              ...
              <div class="portlet-body">                
                    ...
                    <div class="list-group">  
                        ...
                        <a href="account-classes.php" class="list-group-item">
                            ...
                            <i class="fa fa-cog text-primary"></i> &nbsp;&nbsp;Class List
                            <i class="fa fa-chevron-right list-group-chevron"></i>
                        ...
                        <a href="account-schoolschedule.php" class="list-group-item">
                            ...
                            <i class="fa fa-cog text-primary"></i> &nbsp;&nbsp;Past Lessons
                            <i class="fa fa-chevron-right list-group-chevron"></i>

                        </a> 

                        <a href="account-lessonlibrary.php" class="list-group-item">

                            <i class="fa fa-cog text-primary"></i> &nbsp;&nbsp;Lesson Library
                            <i class="fa fa-chevron-right list-group-chevron"></i>

                        </a> 

                        <a href="account-classgrades.php" class="list-group-item">

                            <i class="fa fa-cog text-primary"></i> &nbsp;&nbsp;Class Grades
                            <i class="fa fa-chevron-right list-group-chevron"></i>

                        </a> 
                        <a href="account-classrewards.php" class="list-group-item">

                            <i class="fa fa-cog text-primary"></i> &nbsp;&nbsp;Class Rewards
                            <i class="fa fa-chevron-right list-group-chevron"></i>

                        </a> 
                         <a href="account-classhomework.php" class="list-group-item">

                            <i class="fa fa-cog text-primary"></i> &nbsp;&nbsp;Homework
                            <i class="fa fa-chevron-right list-group-chevron"></i>
                       ...
                       <a href="account-class-event.php" class="list-group-item">
                            ...
                            <i class="fa fa-cog text-primary"></i> &nbsp;&nbsp;Class Tests
                            <i class="fa fa-chevron-right list-group-chevron"></i>
          ...
          <div class="col-md-9 col-sm-9">
            ...
            <div class="portlet">
                ...
                <h3 class="portlet-title">
                    <u>Lesson List</u>
                    <a href="account-classview.php" class="btn btn-secondary"><< Back</a>&nbsp;&nbsp;
                    <a href="mainmenu.php" class="btn btn-secondary">Home</a>&nbsp;&nbsp;
                    <a href="account-classadd.php" class="btn btn-secondary">Add New Lesson</a>&nbsp;&nbsp;
...
<!-- Plugin JS -->
<script src="./js/lessons/table_lessons.js"></script>
