...
<div id="wrapper">
          ...
          <div class="col-md-3 col-sm-6">
            ...
            <div class="portlet">
              ...
              <h4 class="portlet-title">
                  ...
                  <br />
                    <label for="Category" id="CategoryLabel" style="font-size:12px;color:black;font-weight:normal">Category:</label><br />
                    <select name=Category  Width="200"  name="lesson-Category-select" class="lesson-Catetory form-control parsley-validated" data-required="true" >
                          {html_options values=$category_values selected=$category_selected output=$category_output}
                    </select>
              </h4> 
 ...
 <select name="class-teacher-select"  class="class-teacher form-control parsley-validated" data-required="false"  onchange="javascript:UpdateCookie(this);">
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered" id="table-1" style="font-size:11px">
...
<!-- Plugin JS -->
<script src="GetDataClass.js"></script>
