...
<script type="text/javascript">
    ...
    function Loading()
      ...
      function GetLessonLessonNo() {
                          
             Type = "POST";
             Url = "Lessons.svc/GetLessonLessonNo";
...
?> 
 ...
 <script>   SchoolServiceSucceeded(); </script>
            ...
            <div class="list-group">  
                 ...
                 <a href="account-enrollment.php" class="list-group-item">
                  <i class="fa fa-envelope text-primary"></i> &nbsp;&nbsp;Class Enrollment
...
?>                             </span>
                ...
                <a href="account-lessons.php" class="list-group-item">
                  <i class="fa fa-book text-primary"></i> &nbsp;&nbsp;Class Lessons
...
$tsql = "Select count(*) As ClassCount from Lesson where ClassNo = '".$_COOKIE['classno']."'";     
...
?>                             </span>
                ...
                <a href="account-concepts.php" class="list-group-item">
                  <i class="fa fa-book text-primary"></i> &nbsp;&nbsp;Lesson Concepts
...
$tsql = "Select count(*) As ClassCount from Concept where LessonNo = '".$_COOKIE['lessonno']."'";     
...
$tsql = "Select count(*) As ClassCount from Homework where LessonNo = '".$_COOKIE['lessonno']."'";     
...
?>                             </span>
                ...
                <a href="account-classtests.php" class="list-group-item">
                  <i class="fa fa-envelope text-primary"></i> &nbsp;&nbsp;Class Tests
...
$tsql = "Select count(*) As ClassCount from Lesson where ClassNo = '".$_COOKIE['classno']."' And IsTest = 1";     
...
?>                             </span>
        ...
        <div class="col-md-9 col-sm-7">
           ...
           <div class="col-md-8 col-sm-12">
              ...
              <h4>Lesson View&nbsp;&nbsp;&nbsp;&nbsp;
                  <a href="account-lessons.php" class="btn btn-secondary"><< Back</a>&nbsp;&nbsp;
